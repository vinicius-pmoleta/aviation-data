...
import com.aviationdata.search.viewmodel.InternalData
...
class SearchViewModelTest {
    ...
    private fun internalData() = (viewModelHandler as com.aviationdata.search.viewmodel.SearchViewModel).internalData
    ...
    fun `verify search fails when search interaction is handled`() = runBlockingTest {
        ...
        argumentCaptor<ViewState<com.aviationdata.search.view.SearchState>> {
            ...
            assertEquals(com.aviationdata.search.business.Pagination(page = 1), internalData().pagination)
            assertEquals(com.aviationdata.search.view.SearchState(query = DEFAULT_QUERY), internalData().state)
        }
    }
